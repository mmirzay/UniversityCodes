...
namespace Azmoongir
{
    public partial class Q2Deleting : Form
    {
        public Q2Deleting()
        {
            InitializeComponent();
        ...
        private void Q2Deleting_Load(object sender, EventArgs e)
        {
        ...
        private void btnDel_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (res == DialogResult.Yes)
                {
                    ...
                    SqlCommand sqlcmd = new SqlCommand();
                    sqlcmd.Connection = sqlcnn;
                    sqlcmd.CommandText = "delete from q2 where [کد درس]='" + cmbCrsCode.Text + "' and شماره='" + cmbQNum.Text + "'";
                    sqlcnn.Open();
                    try
                    {
